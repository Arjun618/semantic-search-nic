...
DEFAULT_INDEX_PATH = os.path.join(script_dir, "faiss_index.bin")
DEFAULT_ID_MAP_PATH = os.path.join(script_dir, "faiss_id_map.json")
DEFAULT_JSON_PATH = os.path.join(script_dir, "output.json")
...
class FAISSIndexManager:
    ...
    def __init__(self, 
        ...
        self.id_map_path = DEFAULT_ID_MAP_PATH
        self.json_file_path = DEFAULT_JSON_PATH
