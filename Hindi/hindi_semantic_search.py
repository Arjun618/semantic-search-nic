...
class HindiSemanticSearch:
    ...
    """
    def __init__(self, 
                 embeddings_file: Optional[str] = embeddings_file,
    ...
    def load_index(self, index_path: str) -> bool:
        ...
        try:
            ...
            if not self.documents:
                # Look for output_hindi.json in the same directory as this file
                embeddings_path = os.path.join(os.path.dirname(__file__), "output_hindi.json")
                if os.path.exists(embeddings_path):
                    print(f"Loading documents from {embeddings_path}")
